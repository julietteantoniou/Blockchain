...
class Blockchain(object):
    ...
    def new_block(self, proof, previous_hash=None):
        ...
        * The hash of the previous block
        ...
        block = {
            ...
            'proof': proof,
            'previous_hash': previous_hash or self.hash(self.chain(-1)) #first block- 'genesis' block, prev hash is default (1). Second block should point to prev block
        }
    ...
    def hash(self, block):
        ...
        #STEP 1: Convert block into usable string
    ...
    #sender is 0 to indicate new coin, recipient is miner, amount is reward
...
def mine():
    ...
    if not all(i in data for i in required):
        response: {
            'message': 'Error- missing required items'
        }
...
def new_transaction():
    ...
    response = {'message': f"added to blocl {index}"}
